        ...
        <div className="grid lg:grid-cols-2 items-center" style={{ gap: '80px' }}>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-full max-w-md lg:max-w-lg mx-auto">
              <div className="absolute -inset-4 bg-gradient-to-br from-primary/15 to-secondary/15 rounded-3xl blur-2xl" />
              <img
                src="https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=600&h=600&fit=crop&q=80"
                alt="Online shopping bags"
                className="relative w-full h-auto rounded-2xl shadow-2xl object-cover"
              />
              {/* Floating badge - top left */}
              <div className="absolute -top-3 -left-3 sm:-top-5 sm:-left-5 bg-white rounded-xl shadow-lg px-4 py-2.5 flex items-center gap-2.5">
              ...
              <div className="absolute -bottom-3 -right-3 sm:-bottom-5 sm:-right-5 bg-white rounded-xl shadow-lg px-4 py-2.5 flex items-center gap-2.5">
